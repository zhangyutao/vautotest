...
/**
 * the client used to execute a {@link requests.RestfRequest} and also can be
 * single instated to handle Restf web service Request Some properites like
 * proxy you can configured in the file which path is
